...
Ammonium hydroxide dissociates slightly into ammonium ($\text{NH}_4^+$) and hydroxide ($\text{OH}^-$) ions.
...
### 5. What is the result of passing ammonia over mercurous nitrate paper?
