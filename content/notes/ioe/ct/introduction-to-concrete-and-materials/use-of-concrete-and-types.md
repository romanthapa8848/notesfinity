...
### 1. Which type of concrete contains steel reinforcements?
- A) Plain concrete  
- B) **Reinforced cement concrete (✓)**  
- C) Lightweight concrete  
- D) Prestressed concrete  

### 2. What property of concrete makes it ideal for dam construction?
- A) Flexibility  
- B) **High compressive strength (✓)**  
- C) Lightweight  
- D) High tensile strength  

### 3. Which type of concrete is used in long-span structures?
- A) Fiber-reinforced concrete  
- B) Lightweight concrete  
- C) **Prestressed concrete (✓)**  
- D) Plain concrete  

### 4. Which concrete type flows without vibration?
- A) Plain concrete  
- B) **Self-compacting concrete (✓)**  
- C) Fiber-reinforced concrete  
- D) High-performance concrete  

### 5. What material is added to fiber-reinforced concrete?
- A) Cement  
- B) **Fibers (✓)**  
- C) Sand  
- D) Steel tendons  

### 6. Why is lightweight concrete advantageous in construction?
- A) Increased compressive strength  
- B) **Reduced structural weight (✓)**  
- C) Faster setting time  
- D) Improved flexibility  

### 7. What is high-performance concrete known for?
- A) Low cost  
- B) Lightweight properties  
- C) **Enhanced durability and strength (✓)**  
- D) Reduced cement content  

### 8. Which concrete type is commonly used in pavements?
- A) **Plain cement concrete (✓)**  
- B) High-performance concrete  
- C) Self-compacting concrete  
- D) Prestressed concrete  

### 9. What makes concrete suitable for marine structures?
- A) Lightweight properties  
- B) **Resistance to water and corrosion (✓)**  
- C) Tensile strength  
- D) Thermal insulation  

### 10. How can concrete be made more sustainable?
- A) By reducing water content  
- B) **By incorporating recycled materials (✓)**  
- C) By avoiding cement usage  
- D) By using only natural aggregates  
