...
### 1. What is the main function of aggregates in concrete?
- A) Binding the mix  
- B) Initiating hydration  
- C) **Providing bulk and stability (✓)**  
- D) Enhancing workability  

### 2. What type of cement is commonly used for chemical resistance?
- A) Rapid Hardening Cement  
- B) **Portland Pozzolana Cement (✓)**  
- C) Ordinary Portland Cement  
- D) Air-Entrained Cement  

### 3. How does the water-cement ratio affect concrete?
- A) No effect  
- B) **Determines strength and workability (✓)**  
- C) Enhances durability only  
- D) Reduces bulk  

### 4. What type of admixture delays the setting time of concrete?
- A) Accelerators  
- B) **Retarders (✓)**  
- C) Plasticizers  
- D) Air-Entraining Agents  

### 5. Which admixture improves freeze-thaw resistance in concrete?
- A) Plasticizers  
- B) **Air-Entraining Agents (✓)**  
- C) Superplasticizers  
- D) Accelerators  

### 6. What is the primary chemical reaction in cement when mixed with water?
- A) Combustion  
- B) Melting  
- C) **Hydration (✓)**  
- D) Evaporation  

### 7. What is the purpose of superplasticizers in concrete?
- A) Reducing bulk  
- B) **Significant water reduction while maintaining workability (✓)**  
- C) Increasing aggregate content  
- D) Accelerating setting time  

### 8. What happens if too much water is added to a concrete mix?
- A) **Strength decreases (✓)**  
- B) Workability decreases  
- C) Durability increases  
- D) Setting time is reduced  

### 9. Why are coarse aggregates important in concrete?
- A) Reduce hydration  
- B) **Provide strength and reduce voids (✓)**  
- C) Increase cement consumption  
- D) Improve setting time  

### 10. Which component initiates the binding process in concrete?
- A) Aggregates  
- B) **Water (✓)**  
- C) Admixtures  
- D) Sand  
